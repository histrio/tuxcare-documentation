...
Requests for customer-directed security patches for CVEs that are outside of the ELS for Runtimes scope will be reviewed within 3 working days. If the request is accepted, we will provide the patch within the next 60 days.
...
TuxCare's commitment to transparency and visibility is foundational to our ELS for Runtimes offering. We provide verifiable metadata that helps customers understand package composition, software provenance, and vulnerability impact across the software supply chain.
