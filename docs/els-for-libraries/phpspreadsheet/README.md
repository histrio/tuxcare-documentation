...
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?q=phpoffice%2Fphpspreadsheet) — Track vulnerability fixes and updates
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=phpoffice%2Fphpspreadsheet) — Patched versions and changelogs
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/phpoffice/phpspreadsheet/) — Vulnerability Exploitability eXchange feed
