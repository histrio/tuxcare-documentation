...
You can browse SBOM files for karma here:

[https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:karma](https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:karma)
