...
You can browse SBOM files for webpack-dev-server here:

[https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:webpack-dev-server](https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:webpack-dev-server)
