...
You can browse SBOM files for Vite here:

[https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:vite](https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:vite)
