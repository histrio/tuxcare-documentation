...
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/sebastianbergmann-phpunit/) — Machine-readable vulnerability exploitability data
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?product=PHPUnit) — Track vulnerability fixes and updates
