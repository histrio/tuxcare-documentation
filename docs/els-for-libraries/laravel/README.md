...
* ![](/images/shield-alert.webp) [VEX feed — Laravel framework](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/laravel-framework/) — Machine-readable vulnerability exploitability data
* ![](/images/shield-alert.webp) [VEX feed — Illuminate View](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/illuminate-view/) — Machine-readable vulnerability exploitability data
