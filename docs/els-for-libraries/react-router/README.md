...
You need a token in order to use TuxCare ELS react-router library. Anonymous access is disabled. To receive the token, please contact [sales@tuxcare.com](mailto:sales@tuxcare.com).
...
You can browse SBOM files for react-router here:

[https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:react-router](https://nexus.repo.tuxcare.com/#browse/browse:els-js-sbom:react-router)
