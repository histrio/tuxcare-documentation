...
export default {
    ...
    data () {
        return {
            ...
            options: [{
                name: 'TuxCare',
                value:  ['level-0', 'tuxcare']
            },{
                name: 'AlmaCare',
                value: ['level-0', 'almacare']
            },{
                name: 'KernelCare Enterprise',
                value: ['level-0', 'live-patching-services']
            },{
                name: 'KernelCare for IOT',
                value: ['level-0', 'kernelcare-for-iot']
            },{
                name: 'ePortal',
                value: ['level-0', 'eportal']
            },{
                name: 'ePortal API',
                value: ['level-0', 'eportal-api']
            },{
                name: 'Extended Lifecycle Support',
                value: ['level-0', 'extended-lifecycle-support']
            },{
                name: 'Extended Lifecycle Support for Languages',
                value: ['level-0', 'extended-lifecycle-support-for-languages']
            },{
                name: 'Subscription Management Portal',
                value: ['level-0', 'tuxcare-cln']
            },{
                name: 'Service Descriptions',
                value: ['level-0', 'service-descriptions']
            }]
        }
    },
    mounted(){
