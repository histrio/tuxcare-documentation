import{_ as e,q as i,E as s,a9 as n}from"./framework-c51d930c.js";const a={},t=n(`<h1 id="eportal-api" tabindex="-1"><a class="header-anchor" href="#eportal-api" aria-hidden="true">#</a> ePortal API</h1><p>You may need to create a separate ePortal account for API usage with:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>kc.eportal user -a api-user -p &lt;password&gt;
